...
const LoginPage = () => {
    ...
    return (
        <div>
            ...
            <p>made by <div className='person'>Nimisha NB</div>(CS140), <div className='person'>Manas Hejmadi</div>(CS117),<div className='person'> Manish S</div>(CS119), <div className='person'>Raqeeb Haider</div>(CS126)</p>
